...
import { Save, Trash2, MapPin, Flag, Skull, Package, Users, Plus, X, Target, Clock, Navigation, Mountain, Trees, Waves, Flame, Snowflake, Zap, Castle } from 'lucide-react';

const NightreignZonePlanner = () => {
  const [activeZones, setActiveZones] = useState([]);
  const [zoneStrategies, setZoneStrategies] = useState({});
...
export default NightreignZonePlanner;